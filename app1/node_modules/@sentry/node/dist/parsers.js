...
var mainModule = ((require.main && require.main.filename && path.dirname(require.main.filename)) ||
    global.process.cwd()) + "/";
/** JSDoc */
...
function parseError(error) {
    return __awaiter(this, void 0, void 0, function () {
        var e_1, _a, _b, name, exception, event, errorKeys, extraErrorInfo, errorKeys_1, errorKeys_1_1, key, frames, i, frame;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    frames = (exception.stacktrace && exception.stacktrace.frames) || [];
